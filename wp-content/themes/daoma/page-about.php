...
<section class="imagebreak">
  ...
  <img src="img/oma.png" alt="Omaha, NE">
</section>

<div class="activities">
  <section class="interior border">
    <div class="wrapper">
      <h2 class="column">Lectures</h2>
      <div class="content">
        <p>daOMA has established a world class lecture series, that has brought many of the world’s best architects and designers to the city of Omaha and the state of Nebraska for the first time this series has seen a total programming attendance in that time of nearly 8,500&nbsp;people.</p>
      </div>
    </div>
  </section>
  ...
  <section class="interior border">
    <div class="wrapper">
      <h2 class="column">Pecha Kucha</h2>
      <div class="content">
        <p>This world renowned presentation format/venue was added in the second season. It provides the vehicle to feature the work of the best and brightest members of the regional creative community while also connecting Omaha and Nebraska to a larger global network of creative cities. In season 5 we have solidified partnerships with Slowdown and Blue Sushi for the 4 PKN’s we host each season. Unique to PKN-Omaha is our final PKN each season features the best design talents coming out of the design schools in the region and the standout faculty educating these students.</p>
      </div>
    </div>
  </section>
...
<!--parallax-->
<section class="imagebreak">
  <div class="triangle1-lrg" data-type="background" data-speed="-10"></div>
  <img src="img/pkn2.png" alt="Pecha Kucha">
</section>
<section class="board-directors">
  <div class="director">
    <div class="content">
      <h5>Board of directors</h5>
      <p>daOMA&rsquo;s membership is led by a board of directors, who have been selected to represent our partners&rsquo;, design disciplines and/or interests in the areas of architecture, urban design, landscape design, interior design, industrial design, graphic design, photography and fashion design.</p>
    </div>
  </div>

  <div class="director">
    <img alt="Bryce Bridges" src="img/board_bryce.jpg">
    <div class="content">
      <h3>Bryce Bridges</h3>
  ...
  <div class="director">
    <img alt="Drew Davies" src="img/board_drew.jpg">
    <div class="content">
      <h3>Drew Davies</h3>
  ...
  <div class="director">
    <img alt="Jeffrey Day" src="img/board_jeff.jpg">
    <div class="content">
  ...
  <div class="director">
    <img alt="Brian Kelly" src="img/board_brian.jpg">
    <div class="content">
      <h3>Brian Kelly</h3>
  ...
  <div class="director">
    <img alt="Justin Kemerling" src="img/board_justin.jpg">
    <div class="content">
  ...
  <div class="director">
    <img alt="David C. Levy" src="img/board_justin.jpg">
    <div class="content">
      <h3>David C. Levy</h3>
  ...
  <div class="director">
    <img alt="Amy Mather" src="img/board_amy.jpg">
    <div class="content">
      <h3>Amy Mather</h3>
  ...
  <div class="director">
    <img alt="Hesse McGraw" src="img/board_hesse.jpg">
    <div class="content">
      <h3>Hesse McGraw</h3>
  ...
  <div class="director">
    <img alt="James Menard" src="img/board_hesse.jpg">
    <div class="content">
      <h3>James Menard</h3>
      <p>Jeff is a principal of Min | Day, is Professor of Architecture & Landscape Architecture and director of the Architecture Program at the University of Nebraska-Lincoln. He graduated magna cum laude from Harvard College in 1988, with an AB in Visual and Environmental Studies and received a Master of Architecture from U.C. Berkeley in 1995. At UNL Jeff runs FACT (Fabrication And Construction Team), an awardwinning, academic/professional collaborative design&nbsp;lab.</p>
    </div>
  ...
  <div class="director">
    <img alt="Alan Tipp" src="img/board_hesse.jpg">
    <div class="content">
      <h3>Alan Tipp</h3>
  ...
  <div class="director">
    <img alt="Anne Trumble, MLA, ASLA" src="img/board_anne.jpg">
    <div class="content">
  ...
  <div class="director">
    <img alt="Thomas J. Trenolone, AIA" src="img/board_tom.jpg">
    <div class="content">
  ...
  <div class="director">
      <img alt="Sabrina Weiss" src="img/board_sabrina.jpg">
      <div class="content">
        <h3>Sabrina Weiss</h3>
  ...
  <div class="director">
    <img alt="Jake Welchert" src="img/board_jake.jpg">
    <div class="content">
      <h3>Jake Welchert</h3>
      <p>Tom is an architect, design enthusiast and wanna-be ad man. He is a graduate of the University of Nebraska at Lincoln with degrees in both advertising and architecture, and went on to receive his master’s degree in architecture at the University of Kansas, he is a Studio 804 alumnus (216 Alabama). Tom is a Design Principal and Vice President with the international firm of HDR Architecture. He is also a founding partner in the international design collaborative n:dL (nocturnal: design Lab). He established daOMA (design alliance OMAha, Inc.) in 2006 with a mission to bring a greater awareness of progressive architecture and the design arts to Nebraska and western&nbsp;Iowa.</p>
    </div>
